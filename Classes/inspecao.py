...
class Inspecao:
    ...
    def alterar_reinspecao(self, id_inspecao, n_nao_conformidades, qtd_produzida, n_conformidades, causa_reinspecao, inspetor, setor, conjunto_especifico='', categoria='', outraCausaSolda='', origemInspecaoSolda='', observacaoSolda=''):
        ...
        if setor == 'Pintura':
            ...
            if n_conformidades == "0":
                ...
                values = (id_inspecao, id_inspecao, n_conformidades, inspetor, setor, id_inspecao, conjunto_especifico, origemInspecaoSolda, observacaoSolda, id_inspecao, id_inspecao, n_conformidades, inspetor, setor, conjunto_especifico, origemInspecaoSolda, observacaoSolda)
                self.cur.execute(sql_insert, values)
